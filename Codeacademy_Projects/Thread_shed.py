...
daily_transactions= []
daily_transactions = str(daily_sales_replaced).split(',')
...
#Calculate number of thread sold by color
thread_sold_split = []
...
for color in colors:
  ...
  print("The thread of color {color} is sold {count} times".format(color=color,count=count))
